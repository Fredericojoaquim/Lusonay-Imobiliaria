...
<body>
            ...
            <div class="nav-wrapper container ">
              ...
              <a href="<?php echo $_SERVER['PHP_SELF'];?>"><img src="img/site1.png" alt="Lusonay Imobiliaria" class="logo_img"></a> 
                <ul class="right light hide-on-med-and-down">
                    ...
                    <li><a href="carro.php" class="ativo">Veículos</a></li>
 ...
 <!---- </section> -->
 <section  class="homecarro bloco scrollspy" id="home">
    <div class="row container baner">
        <div class="col s12 center margembaner container">
            <h2 class="white-text">O LUGAR CERTO PARA COMPRAR SUA VIATURA</h2>
...
<section class="container">
    <div class="row">
    <h4 class="center blue-text darken-4">Nossas Viaturas</h4>
    </div>
  ...
  <div class="row">
    ...
    <div class="col s12 m6 l3 container">
        <div class="div-title">
                ...
                <span class=""> <h5 class="card-title"><?php echo $t['tipo_negocio']; ?></h5> </span>
            </div>

            <div class="card">

                <div class="card-image">
                     <img src="<?php echo $t['foto_principal']; ?>" class="img_card materialboxed">
                </div>
                <div class="card-content">
                 <p>Marca: <?php echo $t['marca']; ?></p>
                 <p>Modelo: <?php echo $t['modelo']; ?></p>
                 <p>Kilometragem: <?php echo $t['kilometragem']; ?></p>
                 <p>Preço: <?php echo "AOA ".number_format($t['preco'], 2,",",".");?></p>
                 
                 
                  <div class="center divbtnSaibamais"><a href="carrodetalhes.php?id_carro=<?php echo $t['cod_veiculo']; ?>" class="btn blue center btnsaibamais">saber mais...</a></div>
                 </div>
            </div>
    </div>
     <?php
