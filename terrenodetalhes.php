...
if (isset($_GET['id_terreno'])) {
  $codterreno=$val->filtrovalidateId('id_terreno');
  $t=$tDao->buscarDados($codterreno);
  if (empty( $t)) {
    ...
    <section class="home_">
      ...
      <div class="card-panel _container">
            ...
            <div class="slider">
              <ul class="slides">
              <li>
                 <img src=" <?php echo $t['foto_principal'];?>" class="img_slide">
                <!-- random image -->
               
              </li>

              <li>
                 <img src="<?php echo $t['foto1'];?>" class="img_slide">
                <!-- random image -->
              </li>
              <li>
                <img src="<?php echo $t['foto2'];?>" class="img_slide">
                <!-- random image -->
              </li>
              <li>
                <img src="<?php echo $t['foto3'];?>" class="img_slide">
              </li>
              <li>
                <img src="<?php echo $t['foto4'];?>" class="img_slide">
              </li>
        ...
        <p> Tipo de Negócio: <strong>  <?php echo $t['tipo_de_negocio']; ?> </strong></p>
        <p>Dimensão: <?php echo $t['dimensao']; ?></p>
        <p>Descrição do Interior: <?php echo $t['desc_exterior']; ?></p>
        <p>Descrição do Exterior: <?php echo $t['desc_interior']; ?></p>
        
        <p>Preço: <strong> <?php echo "KZ ".number_format($t['preco'], 2,",",".");?> </strong></p>
        <p>Data de registo: <?php echo $t['data_registo']; ?></p>
        <p>País: <?php echo $t['pais']; ?></p>

        <p>Locailidade: <?php echo $t['localidade']; ?></p>
        <p>Município: <?php echo $t['municipio']; ?></p>
        <p>Região: <?php echo $t['regiao']; ?></p>
        <p><?php echo $t['telefone']; ?></p>
