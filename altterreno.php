...
if (isset($_POST['btnSave'])) {
  ...
  }elseif (empty($_POST['desc_exterior'])) {
    $erros[]="<li>O campo Descrição exterior  é um campo obrigatório</li>";
  ...
  }elseif (empty($_POST['dimensao'])) {
    $erros[]="<li>O campo dimensao  é um campo obrigatório</li>";
  ...
  <section class="principal">
    ...
    <div class="">
      ...
      <div class="row">
        ...
        <div class="input-field col s6">
          ...
          <select name="tiponegocio" required>
             <option value="<?php echo $dados['tipo_de_negocio'];?>"><?php echo $dados['tipo_de_negocio'];?></option>
        ...
        <div class="input-field col s6">
          <input id="dimensao" type="text" class="validate" value="<?php echo $dados['dimensao'];?>" name="dimensao" required>
        ...
        <div class="input-field col s6">
          ...
          <select name="prioridade" required>
             <option value="<?php echo $dados['prioridade'];?>"><?php if ($dados['prioridade']==1) { echo "Destaque";}else{echo "Normal";} ?></option>
        ...
        <div class="input-field col s6">
          <input id="preco" type="text" class="validate" value ="<?php echo number_format($dados['preco'], 2,",",".");;?>" name="preco" required>
         ...
         <div class="input-field col s12">
          <input id="desc_interior" type="text" value ="<?php echo $dados['desc_interior'];?>" class="validate" name="desc_interior" required>
          <label for="desc_interior">descrição interior</label>
        </div>

         <div class="input-field col s12">
          <input id="desc_exterior" type="text" class="validate" value="<?php echo $dados['desc_exterior'];?>" name="desc_exterior" required>
          <label for="desc_exterior">descrição exterior</label>
        </div>

         <div class="input-field col s6">
          <input id="pais" type="text" value="<?php echo $dados['pais'];?>" class="validate" name="pais" require>
          <label for="pais">País</label>
        </div>
        <div class="input-field col s6">
          <input id="regiao" type="text" class="validate" value="<?php echo $dados['regiao'];?>" name="regiao" require>
          <label for="regiao">Região</label>
        </div>

        <div class="input-field col s6">
          <input id="loca" type="text" class="validate" value="<?php echo $dados['localidade'];?>" name="localidade" require>
         ...
         <div class="input-field col s6">
          <input id="telefone" type="tel" class="validate"  value="<?php echo $dados['telefone'];?>" name="telefone" required>
          <label for="telefone">Telefone</label>
        </div>

         <div class="input-field col s6">
          <input id="email" type="email" class="validate" value="<?php echo $dados['email'];?>" name="email" required>
        ...
        <div class="input-field col s6">
          ...
          <input  type="hidden" class="validate" value="<?php echo $dados['cod_terreno'];?>" name="codigo">
          <input  type="hidden" class="validate" value="<?php echo $dados['cod_local_fk'];?>" name="codigoloc">
        </div>
      ...
      <div class="right footerbutom">
        ...
        <a href="terreno.php" class="modal-close modal-action waves-effect waves-green btn red">Sair</a>
