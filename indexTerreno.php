...
<body>
            ...
            <div class="nav-wrapper container ">
              ...
              <a href="<?php echo $_SERVER['PHP_SELF'];?>"><img src="img/site1.png" alt="Lusonay Imobiliaria" class="logo_img"></a> 
                <ul class="right light hide-on-med-and-down">
                    ...
                    <li><a href="#terreno" class="ativo">Terrenos</a></li>
 ...
 <!---- </section> -->
 <section  class="home bloco scrollspy" id="terreno">
...
<section class="container scrollspy" >

    <div class="row">
    <h4 class="center blue-text darken-4">TERRENOS</h4>
    </div>
    ...
    <div class="col s12 m6 l3 container">
        <div class="div-title">
                ...
                <span class=""> <h5 class="card-title"><?php echo $t['tipo_de_negocio']; ?></h5> </span>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-content">
                 ...
                 <p>Preço: <?php echo "KZ ".number_format($t['preco'], 2,",",".");?></p>
                 <p>Localidade: <?php echo $t['localidade']; ?></p>
                 <p>Municipio: <?php echo $t['municipio']; ?></p>
                 
                  <div class="center divbtnSaibamais"><a href="terrenodetalhes.php?id_terreno=<?php echo $t['cod_terreno']; ?>" class="btn blue center btnsaibamais">saber mais...</a></div>
                 </div>
            </div>
    </div>
     <?php
