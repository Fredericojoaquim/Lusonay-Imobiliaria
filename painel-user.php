                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="index.php">Gerir utilizador</a>
                        </div>
                    </div>
                </li>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                      ...
                      <div class="row card-panel painel">

                        <div class="">

                            <a href="painel-admin.php" class="btn blue ">Home</a>
                            <a href="" class="btn espaco_btn">Registar</a>
                        </div><br>
