            ...
            <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="painel-user.php">Gerir utilizador</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="index.php?">gerir imóveis</a>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Gestão de veículos:</h6>
                            <a class="collapse-item" href="index.php">Gerir veículos</a>
                        </div>
                    </div>
                </li>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <img class="mt-2 logo-img" src="../img/logolusonay.png" width="150">
                    ...
                    <div class="container-fluid">
                      ...
                      <div class="row">
                        ...
                        <div class="card-panel col s12 m3 red">
                            <br>
                            <br>
                            <br>
                            <br>
                        ...
                        <div class="card-panel col s12 m3 grey">
                            <br>
                            <br>
                            <br>
                            <br>
                        ...
                        <div class="card-panel col s12 m3 green">
                            <br>
                            <br>
                            <br>
                            <br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="col-md-12 mb-2">
                                        <img src="../img/profiles/" alt="Carregue sua Imagem" id="target" width="100%">
                                    </div>
                                </div>
                            </div> 
