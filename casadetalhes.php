...
if (isset($_GET['id_casa'])) {
  $codcasa=$val->filtrovalidateId('id_casa');
  $casa=$cDao->buscarDados($codcasa);
  if (empty($casa)) {
    ...
    <section class="home_">
      ...
      <div class="card-panel _container">
            ...
            <div class="slider">
              <ul class="slides">
              <li>
                 <img src="<?php echo $casa['foto_principal'];?>" class="img_slide">
                <!-- random image -->
              </li>

              <li>
                 <img src="<?php echo $casa['foto1'];?>" class="img_slide">
                <!-- random image -->
              </li>
              <li>
                <img src="<?php echo $casa['foto2'];?>" class="img_slide">
                <!-- random image -->
              </li>
              <li>
                <img src="<?php echo $casa['foto3'];?>" class="img_slide">
              </li>
              <li>
                <img src="<?php echo $casa['foto4'];?>" class="img_slide">
              </li>
        ...
        <p> Tipo de Negócio: <strong>  <?php echo $casa['tipo_negocio']; ?> </strong></p>
        <p>Tipologia: <?php echo $casa['tipologia']; ?></p>
        <p>Quantidade de Wcs: <?php echo $casa['wcs']; ?></p>
        <p>Descrição do interior: <?php echo $casa['desc_interior']; ?></p>
        <p>Descrição do Exterior: <?php echo $casa['desc_exterior']; ?></p>

        <p>Estado: <?php echo $casa['estado']; ?></p>
        <p>Mobilada: <?php echo $casa['mobilada']; ?></p>
        <p>Preço:<strong> <?php echo "KZ ".number_format($casa['preco'], 2,",",".");?></strong></p>
        <p>Data de registo: <?php echo $casa['data_registo']; ?></p>
        <p>País: <?php echo $casa['pais']; ?></p>
        <p>Locailidade: <?php echo $casa['localidade']; ?></p>
        <p>Município: <?php echo $casa['municipio']; ?></p>
        <p>Região: <?php echo $casa['regiao']; ?></p>
        <p> <?php echo $casa['telefone']; ?></p>
        <p> <?php echo $casa['email']; ?></p>
